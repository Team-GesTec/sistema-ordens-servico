 ...
 * campo a campo. Agora ele só traduz HTTP ⇄ service; as regras ficam em `services/serviceProjeto.ts`
 * e o acesso ao banco (Prisma + cache) em `repositories/repositoryProjeto.ts`. Ganhou o PATCH.
 */
