 ...
 * campo a campo. Agora ele só traduz HTTP ⇄ service; as regras ficam em `services/serviceFuncionario.ts`
 * e o acesso ao banco (Prisma + cache) em `repositories/repositoryFuncionario.ts`. Ganhou o PATCH.
 */
