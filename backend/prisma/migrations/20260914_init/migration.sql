...
-- CreateEnum
CREATE TYPE "status_ordem_servico" AS ENUM ('pendente', 'em_andamento', 'aguardando_embarque', 'validacao_testes', 'bloqueado', 'review', 'concluido');

-- CreateEnum
CREATE TYPE "status_projeto" AS ENUM ('pendente', 'em_andamento', 'aguardando_embarque', 'validacao_testes', 'bloqueado', 'review', 'concluido');
...
CREATE TABLE "ordens_servico" (
    ...
    "descricao" TEXT NOT NULL,
    "status" "status_ordem_servico" NOT NULL DEFAULT 'pendente',
...
CREATE TABLE "projetos" (
    ...
    "status" "status_projeto" NOT NULL DEFAULT 'pendente',
...
-- AddForeignKey
ALTER TABLE "anexos" ADD CONSTRAINT "anexos_sla_id_fkey" FOREIGN KEY ("sla_id") REFERENCES "slas"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "ordens_servico" ADD CONSTRAINT "ordens_servico_sla_id_fkey" FOREIGN KEY ("sla_id") REFERENCES "slas"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE "anexos"
ADD CONSTRAINT "anexos_check"
CHECK (
    ("os_id" IS NOT NULL) IS DISTINCT FROM ("sla_id" IS NOT NULL)
);
